...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\materija\RA77-2013\LPRS2_projekat-master\LPRS2_projekat-master
  logical library name                       : rc5controller_v1_00_a
  top name                                   : rc5controller
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- ISE project file(s)
  ...
  devl/projnav/rc5controller.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/rc5controller_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/rc5controller_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/rc5controller_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\materija\RA77-2013\LPRS2_projekat-master\LPRS2_projekat-master\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
